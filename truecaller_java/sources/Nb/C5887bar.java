...
public final class C5887bar {

    /* renamed from: a, reason: collision with root package name */
    public static final TimeZone f39516a = TimeZone.getTimeZone("UTC");

    public static boolean a(String str, char c11, int i11) {
    ...
    */
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Nb.C5887bar.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    public static int c(int i11, int i12, String str) throws NumberFormatException {
        int i13;
        int i14;
