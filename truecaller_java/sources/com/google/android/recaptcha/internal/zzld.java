...
public final class zzld {
    ...
    static {
        ...
        zzc = zzldVar3;
        zzld zzldVar4 = new zzld("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(BitmapDescriptorFactory.HUE_RED));
        zzd = zzldVar4;
        ...
        zzi = zzldVar9;
        zzld zzldVar10 = new zzld(IncomingCallRetriever.ACTIVITY_RESULT_INTENT_EXTRA_MESSAGE, 9, Object.class, Object.class, null);
        zzj = zzldVar10;
        zzk = new zzld[]{zzldVar, zzldVar2, zzldVar3, zzldVar4, zzldVar5, zzldVar6, zzldVar7, zzldVar8, zzldVar9, zzldVar10};
    }

    private zzld(String str, int i11, Class cls, Class cls2, Object obj) {
        this.zzl = cls2;
    }
