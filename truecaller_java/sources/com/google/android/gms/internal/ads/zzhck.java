...
public final class zzhck {
    ...
    static {
        ...
        zzj = zzhckVar10;
        zzhck zzhckVar11 = new zzhck(IncomingCallRetriever.ACTIVITY_RESULT_INTENT_EXTRA_MESSAGE, 10, zzhclVar3, 2);
        zzk = zzhckVar11;
    ...
    private zzhck(String str, int i11, zzhcl zzhclVar, int i12) {
        this.zzt = zzhclVar;
    }
