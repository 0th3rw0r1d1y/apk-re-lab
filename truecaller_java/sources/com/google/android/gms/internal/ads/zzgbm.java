...
public final class zzgbm {
    public static int zza(int i11, int i12) {
        ...
        throw new ArithmeticException(androidx.camera.core.impl.J.a(i11, i12, "overflow: checkedAdd(", ", ", ")"));
    }

    public static int zzb(int i11, int i12, RoundingMode roundingMode) {
    ...
    public static int zzc(int i11, RoundingMode roundingMode) {
        if (i11 <= 0) {
            throw new IllegalArgumentException("x (0) must be > 0");
        }
        switch (zzgbl.zza[roundingMode.ordinal()]) {
            case 1:
                zzgbp.zzb(((i11 + (-1)) & i11) == 0);
                break;
            case 2:
            case 3:
                break;
