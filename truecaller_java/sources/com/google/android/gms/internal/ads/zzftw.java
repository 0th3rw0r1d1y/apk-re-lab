...
final class zzftw {
    ...
    public static /* synthetic */ void zza(zzftw zzftwVar, zzfud zzfudVar, int i11, zzfub zzfubVar) {
        try {
            ...
            zzc.zzb(e11, "switchDisplayMode overlay display to %d from: %s", Integer.valueOf(i11), zzftwVar.zze);
        }
    }
    ...
    public static /* synthetic */ void zzb(zzftw zzftwVar, zzftd zzftdVar, zzfub zzfubVar) {
        try {
            ...
            zzc.zzb(e11, "dismiss overlay display from: %s", zzftwVar.zze);
        }
    }
    ...
    public static /* synthetic */ void zzc(zzftw zzftwVar, zzfty zzftyVar, zzfub zzfubVar) {
        try {
            ...
            zzc.zzb(e11, "show overlay display from: %s", zzftwVar.zze);
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.ads.zzftt] */
    ...
    public final void zzg(final zzfud zzfudVar, final zzfub zzfubVar, final int i11) {
        zzfun zzfunVar = this.zza;
        if (zzfunVar == null) {
            zzc.zza("error: %s", "Play Store not found.");
            ...
            zzfunVar.zzm(new Runnable() { // from class: com.google.android.gms.internal.ads.zzfto
                @Override // java.lang.Runnable
                public final void run() {
                    zzftw.zza(this.zza, zzfudVar, i11, zzfubVar);
                }
            });
        }
    }
