...
public class zzy {
    ...
    public static long getLong(ContentResolver contentResolver, String str, long j11) throws NumberFormatException {
        ...
        if (strZza != null) {
            try {
                long j13 = Long.parseLong(strZza);
    ...
    private static <T> T zza(HashMap<String, T> map, String str, T t11) {
    ...
    private static <T> void zza(Object obj, HashMap<String, T> map, String str, T t11) {
        synchronized (zzy.class) {
            try {
                if (obj == zzcz) {
                    map.put(str, t11);
    ...
    public static boolean zza(ContentResolver contentResolver, String str, boolean z11) {
        ...
        Boolean bool = (Boolean) zza(map, str, Boolean.valueOf(z11));
        if (bool != null) {
