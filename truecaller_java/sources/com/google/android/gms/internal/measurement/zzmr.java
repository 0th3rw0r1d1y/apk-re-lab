...
public final class zzmr {
    ...
    static {
        ...
        zzc = zzmrVar3;
        zzmr zzmrVar4 = new zzmr("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(BitmapDescriptorFactory.HUE_RED));
        zzd = zzmrVar4;
        ...
        zzi = zzmrVar9;
        zzmr zzmrVar10 = new zzmr(IncomingCallRetriever.ACTIVITY_RESULT_INTENT_EXTRA_MESSAGE, 9, Object.class, Object.class, null);
        zzj = zzmrVar10;
        zzl = new zzmr[]{zzmrVar, zzmrVar2, zzmrVar3, zzmrVar4, zzmrVar5, zzmrVar6, zzmrVar7, zzmrVar8, zzmrVar9, zzmrVar10};
    }

    private zzmr(String str, int i11, Class cls, Class cls2, Object obj) {
        this.zzk = cls2;
    }
