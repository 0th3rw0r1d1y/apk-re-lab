...
public enum zzgt {
    ...
    static {
        ...
        for (zzgt zzgtVar : values()) {
            if (map.put(Character.valueOf(zzgtVar.zzH), zzgtVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(zzgtVar)));
            }
        }
    ...
    public static final zzgt zzb(char c11) {
        return (zzgt) zzF.get(Character.valueOf(c11));
    }
