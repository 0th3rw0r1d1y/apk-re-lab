...
final class zzjr {
    public static /* bridge */ /* synthetic */ void zza(byte b11, byte b12, byte b13, byte b14, char[] cArr, int i11) throws zzhr {
        if (!zze(b12)) {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b11, byte b12, char[] cArr, int i11) throws zzhr {
        if (b11 < -62 || zze(b12)) {
            throw new zzhr("Protocol message had invalid UTF-8.");
        }
