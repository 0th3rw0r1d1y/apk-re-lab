...
public final class zzhc {
    ...
    static {
        ...
        zzhc zzhcVar10 = new zzhc(IncomingCallRetriever.ACTIVITY_RESULT_INTENT_EXTRA_MESSAGE, 9, 9, 1, zzhsVar7);
        zzj = zzhcVar10;
    ...
    private zzhc(String str, int i11, int i12, int i13, zzhs zzhsVar) {
        this.zzab = i12;
        int i14 = i13 - 1;
        if (i14 == 1 || i14 == 3) {
            zzhsVar.zza();
