...
public enum zzmv implements zzba {
    ...
    ON_DEVICE_SMART_REPLY_CREATE(ModuleDescriptor.MODULE_VERSION),
    ...
    ON_DEVICE_DI_CREATE(Sdk$SDKError.baz.MRAID_JS_CALL_EMPTY_VALUE),
    ON_DEVICE_DI_LOAD(Sdk$SDKError.baz.DEEPLINK_OPEN_FAILED_VALUE),
    ON_DEVICE_DI_DOWNLOAD(Sdk$SDKError.baz.EVALUATE_JAVASCRIPT_FAILED_VALUE),
    ON_DEVICE_DI_RECOGNIZE(Sdk$SDKError.baz.LINK_COMMAND_OPEN_FAILED_VALUE),
    ON_DEVICE_DI_CLOSE(Sdk$SDKError.baz.JSON_PARAMS_ENCODE_ERROR_VALUE),
    ...
    CLOUD_WEB_SEARCH_DETECT(Sdk$SDKError.baz.OMSDK_DOWNLOAD_JS_ERROR_VALUE),
    CLOUD_WEB_SEARCH_CLOSE(Sdk$SDKError.baz.OMSDK_JS_WRITE_FAILED_VALUE),
    ...
    AGGREGATED_ON_DEVICE_SEGMENTATION(Sdk$SDKError.baz.INVALID_BID_PAYLOAD_VALUE),
    AGGREGATED_CUSTOM_OBJECT_INFERENCE(Sdk$SDKError.baz.INVALID_JSON_BID_PAYLOAD_VALUE),
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(Sdk$SDKError.baz.AD_NOT_LOADED_VALUE),
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(211),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(Sdk$SDKError.baz.PLACEMENT_SLEEP_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(Sdk$SDKError.baz.INVALID_ADUNIT_BID_PAYLOAD_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(Sdk$SDKError.baz.INVALID_GZIP_BID_PAYLOAD_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(Sdk$SDKError.baz.AD_RESPONSE_EMPTY_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(Sdk$SDKError.baz.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(Sdk$SDKError.baz.AD_RESPONSE_TIMED_OUT_VALUE),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(Sdk$SDKError.baz.MRAID_JS_DOES_NOT_EXIST_VALUE),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(Sdk$SDKError.baz.MRAID_JS_COPY_FAILED_VALUE),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(Sdk$SDKError.baz.AD_RESPONSE_RETRY_AFTER_VALUE),
    REMOTE_CONFIG_FETCH(271),
    REMOTE_CONFIG_ACTIVATE(XmlConsts.XML_V_11),
    ...
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(Sdk$SDKError.baz.MRAID_ERROR_VALUE),
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(Sdk$SDKError.baz.INVALID_IFA_STATUS_VALUE),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_CREATE(IronSourceError.ERROR_CODE_NO_CONFIGURATION_AVAILABLE),
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(IronSourceError.ERROR_CODE_USING_CACHED_CONFIGURATION),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(AGCServerException.SERVER_NOT_AVAILABLE),
    ...
    ON_DEVICE_IMAGE_CAPTIONING_CREATE(IronSourceError.ERROR_BN_LOAD_AFTER_LONG_INITIATION),
    ON_DEVICE_IMAGE_CAPTIONING_LOAD(IronSourceError.ERROR_BN_INIT_FAILED_AFTER_LOAD),
    ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(IronSourceError.ERROR_BN_LOAD_WHILE_LONG_INITIATION),
    ON_DEVICE_IMAGE_CAPTIONING_CLOSE(IronSourceError.ERROR_BN_LOAD_PLACEMENT_CAPPED),
    ON_DEVICE_IMAGE_CAPTIONING_MODEL_DOWNLOAD(IronSourceError.ERROR_BN_LOAD_EXCEPTION),
    ON_DEVICE_DOCUMENT_DETECT_CREATE(IronSourceError.ERROR_BN_INSTANCE_LOAD_EMPTY_ADAPTER),
    ON_DEVICE_DOCUMENT_DETECT_LOAD(IronSourceError.ERROR_BN_INSTANCE_INIT_EXCEPTION),
    ...
    ON_DEVICE_SHADOW_REMOVAL_CLOSE(IronSourceError.ERROR_NT_LOAD_PLACEMENT_CAPPED),
