...
public final class FieldType {
    ...
    static {
        ...
        FieldType fieldType10 = new FieldType(IncomingCallRetriever.ACTIVITY_RESULT_INTENT_EXTRA_MESSAGE, 9, 9, collection, javaType7);
        MESSAGE = fieldType10;
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f106082id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i11, int i12, Collection collection, JavaType javaType) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i13 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i13 == 2 || i13 == 3) ? false : true;
    }
