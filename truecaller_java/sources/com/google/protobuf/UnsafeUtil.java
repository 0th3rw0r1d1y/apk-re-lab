...
final class UnsafeUtil {
    ...
    public static boolean getBoolean(boolean[] zArr, long j11) {
        return MEMORY_ACCESSOR.getBoolean(zArr, (j11 * BOOLEAN_ARRAY_INDEX_SCALE) + BOOLEAN_ARRAY_BASE_OFFSET);
    }
    ...
    public static double getDouble(double[] dArr, long j11) {
        return MEMORY_ACCESSOR.getDouble(dArr, (j11 * DOUBLE_ARRAY_INDEX_SCALE) + DOUBLE_ARRAY_BASE_OFFSET);
    }

    public static float getFloat(float[] fArr, long j11) {
        return MEMORY_ACCESSOR.getFloat(fArr, (j11 * FLOAT_ARRAY_INDEX_SCALE) + FLOAT_ARRAY_BASE_OFFSET);
    }

    public static int getInt(int[] iArr, long j11) {
        return MEMORY_ACCESSOR.getInt(iArr, (j11 * INT_ARRAY_INDEX_SCALE) + INT_ARRAY_BASE_OFFSET);
    }

    public static long getLong(long[] jArr, long j11) {
        return MEMORY_ACCESSOR.getLong(jArr, (j11 * LONG_ARRAY_INDEX_SCALE) + LONG_ARRAY_BASE_OFFSET);
    }

    public static Object getObject(Object[] objArr, long j11) {
        return MEMORY_ACCESSOR.getObject(objArr, (j11 * OBJECT_ARRAY_INDEX_SCALE) + OBJECT_ARRAY_BASE_OFFSET);
    }

    public static void putBoolean(boolean[] zArr, long j11, boolean z11) {
        MEMORY_ACCESSOR.putBoolean(zArr, (j11 * BOOLEAN_ARRAY_INDEX_SCALE) + BOOLEAN_ARRAY_BASE_OFFSET, z11);
    }
    ...
    public static void putDouble(double[] dArr, long j11, double d11) {
        MEMORY_ACCESSOR.putDouble(dArr, (j11 * DOUBLE_ARRAY_INDEX_SCALE) + DOUBLE_ARRAY_BASE_OFFSET, d11);
    }

    public static void putFloat(float[] fArr, long j11, float f11) {
        MEMORY_ACCESSOR.putFloat(fArr, (j11 * FLOAT_ARRAY_INDEX_SCALE) + FLOAT_ARRAY_BASE_OFFSET, f11);
    }

    public static void putInt(int[] iArr, long j11, int i11) {
        MEMORY_ACCESSOR.putInt(iArr, (j11 * INT_ARRAY_INDEX_SCALE) + INT_ARRAY_BASE_OFFSET, i11);
    }

    public static void putLong(long[] jArr, long j11, long j12) {
        MEMORY_ACCESSOR.putLong(jArr, (j11 * LONG_ARRAY_INDEX_SCALE) + LONG_ARRAY_BASE_OFFSET, j12);
    }

    public static void putObject(Object[] objArr, long j11, Object obj) {
        MEMORY_ACCESSOR.putObject(objArr, (j11 * OBJECT_ARRAY_INDEX_SCALE) + OBJECT_ARRAY_BASE_OFFSET, obj);
    }
