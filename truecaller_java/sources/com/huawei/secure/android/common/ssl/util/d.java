...
public abstract class d {
    ...
    private static final String f107442a = "IOUtil";

    /* renamed from: b, reason: collision with root package name */
    private static final int f107443b = 4096;
    ...
    public static void a(Closeable closeable) throws IOException {
        if (closeable != null) {
            try {
                ...
                e.b(f107442a, "closeSecure IOException");
            }
        }
    }
    ...
    public static void a(File file) {
        ...
        e.b(f107442a, "deleteSecure exception");
    }
