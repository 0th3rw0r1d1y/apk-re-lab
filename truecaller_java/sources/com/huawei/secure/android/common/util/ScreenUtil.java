...
public class ScreenUtil {
    ...
    private static final String f107480a = "ScreenUtil";

    /* renamed from: b, reason: collision with root package name */
    private static final int f107481b = 524288;
    ...
    public static class a implements PrivilegedAction {
        ...
        public a(Method method) {
            this.f107482a = method;
        }

        @Override // java.security.PrivilegedAction
        public Object run() throws SecurityException {
            Method method = this.f107482a;
            if (method == null) {
                return null;
            }
    ...
    public static void hideOverlayWindows(Activity activity) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            LogsUtil.e(f107480a, "hideOverlayWindows ClassNotFoundException");
        } catch (IllegalAccessException unused2) {
            LogsUtil.e(f107480a, "hideOverlayWindows IllegalAccessException");
        } catch (NoSuchMethodException unused3) {
            LogsUtil.e(f107480a, "hideOverlayWindows NoSuchMethodException");
        } catch (InvocationTargetException unused4) {
            LogsUtil.e(f107480a, "hideOverlayWindows InvocationTargetException");
        }
    }
}
