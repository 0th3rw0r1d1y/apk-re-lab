...
public class a {
    ...
    public static String[] a(String str, int i11, int i12) {
        String[] strArrA = a(str, i11);
        return b(a(strArrA, 0), a(a(strArrA, 1), i12 - i11));
    }

    public static String[] a(String str, int i11, int i12, int i13) {
        String[] strArrA = a(str, i11);
        return b(a(strArrA, 0), a(a(strArrA, 1), i12 - i11, i13 - i11));
    }
    ...
    public static String a(String str, String str2, String str3) {
        ...
        for (int i11 = 0; i11 < charArray.length; i11++) {
            ...
            int iLastIndexOf = str2.lastIndexOf(c11);
            if (iLastIndexOf < 0) {
                cArr[i11] = c11;
            } else {
                cArr[i11] = iLastIndexOf >= str3.length() ? cCharAt : str3.charAt(iLastIndexOf);
            }
        }
