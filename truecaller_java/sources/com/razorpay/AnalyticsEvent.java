...
enum AnalyticsEvent {
    ...
    HANDOVER_ERROR("ch:and", "merch:cb:handover", d9.f.f112391e),
    CHECKOUT_LOADED("ch:and", "checkout", d9.h.f112521r),
    ...
    WEB_VIEW_SSL_ERROR("ch:and", d9.h.f112470K, "ssl:error"),
    ...
    WEB_VIEW_UNEXPECTED_NULL("ch:and", d9.h.f112470K, "null"),
    WEB_VIEW_PRIMARY_TO_SECONDARY_SWITCH("ch:and", d9.h.f112470K, "primary:secondary"),
    WEB_VIEW_SECONDARY_TO_PRIMARY_SWITCH("ch:and", d9.h.f112470K, "secondary:primary"),
    ...
    CHECKOUT_RENDERED_COMPLETE("ch:and", Reporting.EventType.RENDER, "complete"),
    ...
    MAGIC_SHOW_WEBVIEW("magic:and", d9.h.f112470K, C13510m5.f113874v),
    MAGIC_SHOW_WEBVIEW_CLICKED("magic:and", "show:webview", Reporting.EventType.VIDEO_AD_CLICKED),
    ...
    MAGIC_OTP_SHOW("magic:and", "otp", C13510m5.f113874v),
    MAGIC_OTP_RESEND_CLICKED("magic:and", "otp:resend", Reporting.EventType.VIDEO_AD_CLICKED),
    MAGIC_OTP_MANUAL_VIEW_CLICKED("magic:and", "otp:manual:view", Reporting.EventType.VIDEO_AD_CLICKED),
    MAGIC_USE_MANUAL_OTP_CLICKED("magic:and", "otp:manual:use", Reporting.EventType.VIDEO_AD_CLICKED),
    MAGIC_USE_OTP_CLICKED("magic:and", "otp:use", Reporting.EventType.VIDEO_AD_CLICKED),
    MAGIC_CHOICE_OTP_CLICKED("magic:and", "choice:otp", Reporting.EventType.VIDEO_AD_CLICKED),
    MAGIC_CHOICE_PASSWORD_CLICKED("magic:and", "choice:password", Reporting.EventType.VIDEO_AD_CLICKED),
    ...
    public static String constructEventName(String str, String str2, String str3) {
        return androidx.core.provider.b.a(str, "_", str2, "_", str3);
    }
