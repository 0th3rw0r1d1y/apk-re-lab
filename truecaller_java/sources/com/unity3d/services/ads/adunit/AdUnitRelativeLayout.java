...
public class AdUnitRelativeLayout extends RelativeLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (this._shouldCapture && this._motionEvents.size() < this._maxEvents) {
            boolean z11 = (motionEvent.getFlags() & 1) != 0;
            synchronized (this._motionEvents) {
                this._motionEvents.add(new AdUnitMotionEvent(motionEvent.getActionMasked(), z11, motionEvent.getToolType(0), motionEvent.getSource(), motionEvent.getDeviceId(), motionEvent.getX(0), motionEvent.getY(0), motionEvent.getEventTime(), motionEvent.getPressure(0), motionEvent.getSize(0)));
            }
        }
        return false;
    }

    public void startCapture(int i11) {
        this._maxEvents = i11;
