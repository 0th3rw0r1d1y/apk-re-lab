...
public enum EnumC12404Pw {
    ...
    public static String A00(int i11, int i12, int i13) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(f93123A00, i11, i11 + i12);
        for (int i14 = 0; i14 < bArrCopyOfRange.length; i14++) {
            bArrCopyOfRange[i14] = (byte) ((bArrCopyOfRange[i14] ^ i13) ^ 53);
        }
        return new String(bArrCopyOfRange);
    }

    public static void A01() {
        f93123A00 = new byte[]{66, 69, 64, 65, 91, 75, 81, 80, 91, 75, 74, 91, 84, 72, 69, 93, 101, 98, 122, 127, 101, 110, 96, 105, 5, 26, 0, 26, 17, 31, 22};
    }
    ...
    public static EnumC12404Pw[] valuesCustom() throws CloneNotSupportedException {
