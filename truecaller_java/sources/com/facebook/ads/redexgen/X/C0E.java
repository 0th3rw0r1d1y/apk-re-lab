...
public final class C0E {
    ...
    public static String A00(int i11, int i12, int i13) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(f92027A00, i11, i11 + i12);
    ...
    public static void A02() {
        f92027A00 = new byte[]{53, 124, 102, 53, 123, 122, 97, 53, 113, 124, 103, 112, 118, 97, 122, 103, 108, 52, 7, 42, 49, 38, MetadataMasks.ConfigurablePathSegmentMask, 55, 44, 49, 58, 99, 102, 48, 99, MetadataMasks.ConfigurablePathSegmentMask, 34, 45, 100, 55, 99, 33, 38, 99, MetadataMasks.ConfigurablePathSegmentMask, 49, 38, 34, 55, 38, 39, 110, 89, 89, 68, 89, 11, 89, 78, 72, 89, 78, 74, 95, 78, 11, 81, 78, 89, 68, 6, 88, 66, 81, 78, 11, 77, 66, 71, 78, 11, 36, 19, 19, 14, 19, 65, 18, 4, 21, 65, 13, 0, 18, 21, 65, 12, 14, 5, 8, 7, 8, 4, 5, 65, 5, 0, 21, 4, 65, 21, 14, 65, 69, 106, 111, 102, 35, 99, 102, 117};
    }
    ...
    public static void A04(File file) throws IOException {
        ...
        byte b11 = randomAccessFile.readByte();
