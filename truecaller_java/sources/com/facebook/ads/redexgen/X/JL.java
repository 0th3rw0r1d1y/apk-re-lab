...
public enum JL {
    ...
    A04(500),
    A09(800),
    A08(Constants.RHYTHM_PLAYER_ERROR_CAN_NOT_OPEN),
    A0A(Constants.RHYTHM_PLAYER_ERROR_CAN_NOT_PLAY),
    A0B(Constants.RHYTHM_PLAYER_ERROR_FILE_OVER_DURATION_LIMIT),
    A03(201),
    A06(400);
    ...
    public static JL A00(int i11) {
        for (JL jl2 : values()) {
            if (jl2.f92820A00 == i11) {
                return jl2;
            }
        }
        return null;
    ...
    public final int A03() {
        return this.f92820A00;
    }

    public final AdPlacementType A04() {
        switch (JK.f92819A00[ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
