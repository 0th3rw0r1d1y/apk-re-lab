...
public final class C12743bQ {

    /* renamed from: A00, reason: collision with root package name */
    public static String[] f93701A00 = {"TtNs1UbtruECXot", "tpaue", "s90Sw2xfipZOkULUf4YVkqTv1ri2JEFZ", "UW9U9pyLqubavRm8Co8t1ARkgbl4JN3Q", "Ubll", "jCd34Nuc8OSCD22", "PumDfveAcRoz4mAMU1oiRh2I021HXL7u", "7XnL499JY0auPeNFsvc8kwtFVWOKtFwM"};
    ...
    public static boolean A00(View view, Rect rect, Rect rect2, Rect rect3) {
        ...
        if (!rect.intersect(rect3)) {
            rect2.setEmpty();
            rect.setEmpty();
            if (f93701A00[6].charAt(7) != 'A') {
                throw new RuntimeException();
            }
            String[] strArr = f93701A00;
