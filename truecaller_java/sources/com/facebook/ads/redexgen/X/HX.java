...
public final class HX {
    ...
    public final int A02() {
        return this.f92740A00;
    }

    public final long A03(int i11) {
        if (i11 >= 0 && i11 < this.f92740A00) {
            return this.A01[i11];
        }
        throw new IndexOutOfBoundsException(A00(10, 14, 44) + i11 + A00(0, 10, 25) + this.f92740A00);
    }

    public final void A04(long j11) {
        int i11 = this.f92740A00;
        long[] jArr = this.A01;
        if (i11 == jArr.length) {
            int i12 = i11 * 2;
            String[] strArr = A03;
        ...
        long[] jArr2 = this.A01;
        int i13 = this.f92740A00;
        this.f92740A00 = i13 + 1;
        jArr2[i13] = j11;
    }

    public final long[] A05() {
        return Arrays.copyOf(this.A01, this.f92740A00);
    }
}
