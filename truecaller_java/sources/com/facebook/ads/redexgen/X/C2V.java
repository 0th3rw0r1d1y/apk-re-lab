...
public final class C2V extends Drawable {
    ...
    public C2V(ColorStateList colorStateList, float f11) {
        this.A01 = f11;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = C2X.A01(this.f92118A00, this.A01, this.A07);
            float vInset = C2X.A00(this.f92118A00, this.A01, this.A07);
    ...
    public final void A06(float f11) {
        if (f11 == this.A01) {
            return;
        }
        this.A01 = f11;
    ...
    public final void A07(float f11, boolean z11, boolean z12) {
        if (f11 == this.f92118A00) {
    ...
    public final boolean onStateChange(int[] iArr) {
        ...
        boolean z11 = colorForState != newColor;
        if (z11) {
