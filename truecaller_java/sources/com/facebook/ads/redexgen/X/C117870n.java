...
import com.facebook.ads.redexgen.X.C117870n;
...
public final class C117870n {
    ...
    public final InterfaceC12210If A05;

    /* renamed from: A00, reason: collision with root package name */
    public long f92046A00 = 0;
    public String A04 = null;
    public EnumC117800f A02 = null;

    public static String A02(int i11, int i12, int i13) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A06, i11, i11 + i12);
        for (int i14 = 0; i14 < bArrCopyOfRange.length; i14++) {
            bArrCopyOfRange[i14] = (byte) ((bArrCopyOfRange[i14] ^ i13) ^ FacebookMediationAdapter.ERROR_MAPPING_NATIVE_ASSETS);
        }
        return new String(bArrCopyOfRange);
    }

    public static void A03() {
        A06 = new byte[]{44, 47, 45, 37, 17, 58, 39, 35, 43, 8, 1, 5, 18, 1, 59, MetadataMasks.ComponentParamMask, 13, 9, 1, 10, MetadataMasks.ComponentParamMask, 17, 6, 10, 8, 0};
    }
    ...
    public C117870n(InterfaceC12210If interfaceC12210If, final Activity activity, int i11) {
        this.A05 = interfaceC12210If;
    ...
    public static C117870n A00(InterfaceC12210If interfaceC12210If, Activity activity) {
        return A01(interfaceC12210If, activity, Build.VERSION.SDK_INT);
    }

    public static C117870n A01(InterfaceC12210If interfaceC12210If, Activity activity, int i11) {
        if (activity != null && i11 >= 14) {
            return new C117870n(interfaceC12210If, activity, i11);
        }
        return null;
    }

    private void A04(String str, long j11, long j12, EnumC117800f enumC117800f) {
        HashMap map = new HashMap();
        map.put(A02(9, 10, 8), Long.toString(j11));
        map.put(A02(0, 9, 34), Long.toString(j12));
        if (enumC117800f != null) {
            map.put(A02(19, 7, 9), enumC117800f.name());
        }
    ...
    public final void A05() {
        ...
        A04(this.A04, this.f92046A00, System.currentTimeMillis(), this.A02);
    ...
    public final void A06(EnumC117800f enumC117800f) {
        this.A02 = enumC117800f;
    }

    public final void A07(String str) {
        this.A04 = str;
        if (this.A03 != null && this.A01 != null) {
            this.f92046A00 = System.currentTimeMillis();
            this.A01.registerActivityLifecycleCallbacks(this.A03);
            return;
        }
        EnumC117800f enumC117800f = EnumC117800f.A03;
        if (A07[2].charAt(6) == '9') {
