...
public final class C0N extends BufferedInputStream {
    ...
    public int f92031A00;
    public int A01;
    public boolean A02;

    public C0N(InputStream inputStream) {
        super(inputStream);
        this.f92031A00 = Integer.MAX_VALUE;
    }
    ...
    public final int read(byte[] bArr) throws IOException {
        if (this.A01 + bArr.length > this.f92031A00) {
            this.A02 = true;
            return -1;
        }
    ...
    public final synchronized int read(byte[] bArr, int i11, int i12) throws IOException {
        if (this.A01 + i12 > this.f92031A00) {
            this.A02 = true;
            return -1;
        }
    ...
    public final synchronized long skip(long j11) throws IOException {
        int i11 = this.A01;
        if (i11 + j11 > this.f92031A00) {
            this.A02 = true;
            return 0L;
        }
        this.A01 = (int) (i11 + j11);
