...
public final class C3I {
    ...
    public static Method f92158A00;
    ...
    public static String A03(int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < bArrCopyOfRange.length; i14++) {
            ...
            A02[5] = "REfXy77BkkgR1";
            bArrCopyOfRange[i14] = (byte) ((b11 ^ i13) ^ 54);
        }
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f92158A00 = ViewConfiguration.class.getDeclaredMethod(A03(82, 21, 45), new Class[0]);
    ...
    public static float A02(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f92158A00) != null) {
            try {
