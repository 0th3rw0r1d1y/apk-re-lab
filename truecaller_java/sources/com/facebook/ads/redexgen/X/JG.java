...
public final class JG {
    ...
    public final AdErrorType f92816A00;
    public final String A01;

    public JG(int i11, String str) {
        this(AdErrorType.adErrorTypeFromCode(i11), str);
    }

    public JG(AdErrorType adErrorType, String str) {
        str = TextUtils.isEmpty(str) ? adErrorType.getDefaultErrorMessage() : str;
        this.f92816A00 = adErrorType;
        this.A01 = str;
    }
    ...
    public static JG A02(JH jh2) {
        return new JG(jh2.A00(), jh2.A01());
    }

    public final AdErrorType A03() {
        return this.f92816A00;
    }
