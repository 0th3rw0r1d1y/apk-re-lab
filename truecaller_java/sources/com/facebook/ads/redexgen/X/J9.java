...
public enum J9 {
    ...
    public static String A01(int i11, int i12, int i13) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(f92811A00, i11, i11 + i12);
    ...
    public static void A02() {
        f92811A00 = new byte[]{-57, -56, -55, -60, -40, -49, -41, -11, -20, -20, 22, 21};
    }
    ...
    public static VideoAutoplayBehavior A00(J9 j92) {
        if (j92 == null) {
            return VideoAutoplayBehavior.DEFAULT;
        }
        switch (J8.f92810A00[j92.ordinal()]) {
            case 1:
                return VideoAutoplayBehavior.DEFAULT;
            case 2:
