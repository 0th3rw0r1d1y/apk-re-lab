...
public final class C12534Ux implements HC {
    ...
    public static final C12534Ux A04;

    /* renamed from: A00, reason: collision with root package name */
    public int f93383A00;
    ...
    static {
        A03();
        A04 = new C12534Ux(Collections.emptyMap());
    }

    public C12534Ux(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C12534Ux A00(DataInputStream dataInputStream) throws IOException {
        ...
        return new C12534Ux(map);
    }

    public static Map<String, byte[]> A02(Map<String, byte[]> otherMetadata, HE he2) {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C12534Ux.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C12534Ux A08(HE he2) {
        Map<String, byte[]> mapA02 = A02(this.A01, he2);
        if (A06(mapA02)) {
            return this;
        }
        return new C12534Ux(mapA02);
    }
    ...
    public final long A5l(String str, long j11) {
