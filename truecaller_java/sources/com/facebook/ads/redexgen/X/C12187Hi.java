...
public final class C12187Hi {
    ...
    public int f92749A00;
    public int A01;
    public int A02;
    public byte[] A03;

    public C12187Hi(byte[] bArr, int i11, int i12) {
        A08(bArr, i11, i12);
    }
    ...
    */
    private void A01() {
        /*
            ...
            if (r4 < 0) goto L2c
            int r3 = r5.A01
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C12187Hi.A04
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 29
            if (r1 == r0) goto L2e
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C12187Hi.A04
        ...
        L2e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C12187Hi.A01():void");
    }
    ...
    public final int A05(int i11) {
        int i12;
        int i13 = 0;
        int returnValue = this.f92749A00;
        this.f92749A00 = returnValue + i11;
        while (true) {
            i12 = this.f92749A00;
            if (i12 <= 8) {
                break;
            ...
            byte[] bArr = this.A03;
            int i15 = this.A02;
            int returnValue2 = bArr[i15];
            i13 |= (returnValue2 & 255) << i14;
            int returnValue3 = i15 + 1;
            if (!A02(returnValue3)) {
                i = 1;
            }
            this.A02 = i15 + i;
        ...
        byte[] bArr2 = this.A03;
        int i16 = this.A02;
        int returnValue4 = bArr2[i16];
        int i17 = returnValue4 & 255;
        String[] strArr = A04;
        String str = strArr[5];
        ...
        int returnValue6 = 8 - i12;
        int i18 = i13 | (i17 >> returnValue6);
        int returnValue7 = (-1) >>> (32 - i11);
        int i19 = i18 & returnValue7;
        if (i12 == 8) {
            this.f92749A00 = 0;
            int returnValue8 = i16 + 1;
            this.A02 = i16 + (A02(returnValue8) ? 2 : 1);
        }
        A01();
        return i19;
    }
    ...
    public final void A07(int i11) {
        ...
        this.A02 = numBytes;
        int i13 = this.f92749A00 + (i11 - (oldByteOffset * 8));
        this.f92749A00 = i13;
        if (i13 > 7) {
            int i14 = numBytes + 1;
            String[] strArr = A04;
    ...
    */
    public final boolean A09() {
        ...
        L2e:
            ...
            goto L1d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C12187Hi.A09():boolean");
    }

    public final boolean A0A() {
        boolean returnValue = (this.A03[this.A02] & (128 >> this.f92749A00)) != 0;
        A06();
        return returnValue;
    }
    ...
    public final boolean A0B(int i11) {
        ...
        int newBitOffset = (this.f92749A00 + i11) - (oldByteOffset * 8);
        if (newBitOffset > 7) {
            i12++;
            newBitOffset -= 8;
        }
