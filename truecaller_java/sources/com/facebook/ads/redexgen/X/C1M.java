...
public final class C1M implements Serializable {
    ...
    public static String A02(int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < bArrCopyOfRange.length; i14++) {
            bArrCopyOfRange[i14] = (byte) ((bArrCopyOfRange[i14] ^ i13) ^ 92);
        }
        return new String(bArrCopyOfRange);
    }

    public static void A03() {
        A09 = new byte[]{37, 52, 53, 52, 49, 52, 64, 84, 67, 21, 67, 17, 66, 65, 4, 30, 23, 30, 19, 30, 68, 82, 23, 71, 23, 70, 23, 72, 58, 127, 127, 45, 41, 33, 41, 127, 127, 59, 57, 57, 63, 52, 46, 5, 57, 53, 54, 53, 40, 110, 107, 83, 111, 99, 96, 99, 126, 57, 52, 63, 34, 4, 56, 52, 55, 52, 41, 13, 26, 15, 49, 13, 1, 2, 1, 28, 105, 126, 107, 85, 105, 101, 102, 101, 120, 85, 101, 124, 111, 120, 85, 103, 111, 110, 99, 107, 1, 22, 3, 61, 22, 7, 26, 22, 61, 1, 13, 14, 13, MetadataMasks.ComponentParamMask, 31, 8, 29, 35, 8, 25, 4, 8, 35, 31, 19, MetadataMasks.ComponentParamMask, 19, 14, 35, 19, 10, 25, 14, 35, 17, 25, 24, 21, 29, 43, 45, 58, 44, 49, 44, 52, 61, 7, 59, 55, 52, 55, 42, 83, 78, 83, 75, 66, 120, 68, 72, 75, 72, 85};
    }
    ...
    public C1M(int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19) {
        this.f92071A00 = i11;
        this.A01 = i12;
        this.A02 = i13;
        this.A03 = i14;
    ...
    public static int A00(JSONObject jSONObject, String str, int i11) {
    ...
    public final int A04(boolean z11) {
        if (z11) {
            return -1;
        }
        return this.f92071A00;
    }

    public final int A05(boolean z11) {
        if (z11) {
            return -1;
        }
        return this.A01;
    ...
    public final int A06(boolean z11) {
        if (z11) {
            return -1;
        }
        return this.A02;
    ...
    public final int A07(boolean z11) {
        return z11 ? A0E : this.A03;
    }

    public final int A08(boolean z11) {
        return z11 ? this.A05 : this.A04;
    }

    public final int A09(boolean z11) {
        return z11 ? this.A07 : this.A06;
    }

    public final int A0A(boolean z11) {
        if (z11) {
            return -1;
        }
        return this.A08;
