...
public enum AdErrorType {
    ...
    NETWORK_ERROR(1000, A00(ps.f115278f, 13, 82), true),
    ...
    AD_REQUEST_FAILED(1111, A00(IronSourceError.ERROR_BN_BINDING_SKIP_INVISIBLE, 39, 71), false),
    AD_REQUEST_TIMEOUT(1112, A00(662, 42, 56), false),
    PARSER_FAILURE(cs.a.f112204b, A00(IronSourceError.ERROR_DO_RV_CALL_LOAD_BEFORE_SHOW, 50, 14), false),
    UNKNOWN_RESPONSE(cs.a.f112205c, A00(2343, 47, 51), false),
    ERROR_MESSAGE(cs.a.f112209g, A00(575, 48, 14), true),
    NO_AD_PLACEMENT(1302, A00(IronSourceError.ERROR_NT_LOAD_PLACEMENT_CAPPED, 42, 45), false),
    MEDIATION_ERROR(3001, A00(1926, 15, 30), true),
    BID_IMPRESSION_MISMATCH(WearableStatusCodes.DUPLICATE_LISTENER, A00(465, 36, 10), true),
    BID_PAYLOAD_ERROR(WearableStatusCodes.UNKNOWN_LISTENER, A00(1673, 19, 67), false),
    NO_ADAPTER_ON_LOAD(IronSourceConstants.errorCode_biddingDataException, A00(292, 25, 116), false),
    NO_ADAPTER_ON_START(IronSourceConstants.errorCode_isReadyException, A00(Sdk$SDKError.baz.AD_CLOSED_TEMPLATE_ERROR_VALUE, 26, 15), false),
    ...
    WEB_VIEW_CACHE_FILE_WAS_DENIED(IronSourceConstants.errorCode_loadException, A00(RtcEngineEvent.EvtType.EVT_MEDIA_ENGINE_EVENT, 43, 24), false),
    ...
    IMAGE_CACHE_ERROR(JosStatusCodes.RTN_CODE_NO_SUPPORT_JOS, A00(999, 21, 85), false),
    LOAD_AD_CALLED_MORE_THAN_ONCE(JosStatusCodes.RNT_CODE_NO_JOS_INFO, A00(1768, 38, 24), true);
    ...
    AdErrorType(int i11, String str, boolean z11) {
        this.f92016A00 = i11;
        this.A01 = str;
        this.A02 = z11;
    }

    public static AdErrorType adErrorTypeFromCode(int i11) {
        return adErrorTypeFromCode(i11, UNKNOWN_ERROR);
    }

    public static AdErrorType adErrorTypeFromCode(int i11, AdErrorType adErrorType) {
        for (AdErrorType adErrorType2 : valuesCustom()) {
            if (adErrorType2.getErrorCode() == i11) {
                return adErrorType2;
            }
        }
        return adErrorType;
