...
public class ViewPager$SavedState extends AbsSavedState {
    ...
    public static String A01(int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < bArrCopyOfRange.length; i14++) {
            bArrCopyOfRange[i14] = (byte) ((bArrCopyOfRange[i14] ^ i13) ^ 31);
        }
    ...
    static {
        ...
        CREATOR = new Parcelable.ClassLoaderCreator<ViewPager$SavedState>() { // from class: com.facebook.ads.redexgen.X.3T
            ...
            public final ViewPager$SavedState[] newArray(int i11) {
                return new ViewPager$SavedState[i11];
            }
        };
    }
    ...
    public final String toString() {
        return A01(10, 25, 49) + Integer.toHexString(System.identityHashCode(this)) + A01(0, 10, 37) + this.f91955A00 + A01(35, 1, 12);
    }

    @Override // com.facebook.ads.internal.androidx.support.v4.view.AbsSavedState, android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i11) {
        super.writeToParcel(parcel, i11);
        parcel.writeInt(this.f91955A00);
        parcel.writeParcelable(this.A01, i11);
    }
}
