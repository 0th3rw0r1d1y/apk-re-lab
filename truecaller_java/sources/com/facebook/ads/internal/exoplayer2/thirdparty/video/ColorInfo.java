...
import com.facebook.ads.redexgen.X.C12202Hx;
...
public final class ColorInfo implements Parcelable {
    ...
    public ColorInfo(Parcel parcel) {
        ...
        boolean hasHdrStaticInfo = C12202Hx.A0f(parcel);
    ...
    public final int hashCode() {
        if (this.f92014A00 == 0) {
            ...
            this.f92014A00 = ((result2 + result3) * 31) + Arrays.hashCode(this.A04);
        }
        int result4 = this.f92014A00;
        return result4;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i11) {
        ...
        C12202Hx.A0V(parcel, this.A04 != null);
        byte[] bArr = this.A04;
        if (bArr != null) {
