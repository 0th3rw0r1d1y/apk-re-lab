...
public class AdViewConstructorParams {
    ...
    public AdViewConstructorParams(Context context, AttributeSet attributeSet, int i11) {
        this.mInitializationType = 2;
        this.mContext = context;
        this.mAttributeSet = attributeSet;
        this.mDefStyleAttr = i11;
        this.mDefStyleRes = 0;
    }

    public AdViewConstructorParams(Context context, AttributeSet attributeSet, int i11, int i12) {
        this.mInitializationType = 3;
        this.mContext = context;
        this.mAttributeSet = attributeSet;
        this.mDefStyleAttr = i11;
        this.mDefStyleRes = i12;
    }
}
