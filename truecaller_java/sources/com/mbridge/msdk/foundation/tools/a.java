...
public class a {
    ...
    private static byte[] f122671b = new byte[32];

    /* renamed from: a, reason: collision with root package name */
    private static byte[] f122670a = new byte[16];

    /* renamed from: com.mbridge.msdk.foundation.tools.a$a, reason: collision with other inner class name */
    public static class C1107a extends Provider {
        public C1107a() {
    ...
    private static void a(String str) {
        ...
        try {
            ...
            System.arraycopy(bArrDigest, 0, f122671b, 0, 32);
            System.arraycopy(bArrDigest, 32, f122670a, 0, 16);
        } catch (Exception e11) {
            e11.printStackTrace();
        }
    }
    ...
    public static String b(String str) {
        return a(str, f122671b, f122670a);
    }
    ...
    public static String a(String str, byte[] bArr, byte[] bArr2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        try {
            ...
            Security.addProvider(new C1107a());
