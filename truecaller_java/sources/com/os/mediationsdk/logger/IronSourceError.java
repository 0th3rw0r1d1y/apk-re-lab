...
public class IronSourceError {
    ...
    private String f114303a;

    /* renamed from: b, reason: collision with root package name */
    private int f114304b;

    public IronSourceError(int i11, String str) {
        this.f114304b = i11;
        this.f114303a = str == null ? "" : str;
    }
    ...
    public String toString() {
        return "errorCode:" + this.f114304b + ", errorMessage:" + this.f114303a;
    }
}
