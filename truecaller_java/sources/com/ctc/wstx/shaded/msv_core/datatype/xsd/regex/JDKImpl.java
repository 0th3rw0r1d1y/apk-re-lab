...
final class JDKImpl extends RegExpFactory {
    ...
    public JDKImpl() throws Exception {
        Class<?> clsLoadClass = JDKImpl.class.getClassLoader().loadClass("com.sun.org.apache.xerces.internal.impl.xpath.regex.RegularExpression");
    ...
    public RegExp compile(String str) throws IllegalAccessException, InstantiationException, IllegalArgumentException, ParseException, InvocationTargetException {
        try {
            ...
            return new RegExp() { // from class: com.ctc.wstx.shaded.msv_core.datatype.xsd.regex.JDKImpl.1
                @Override // com.ctc.wstx.shaded.msv_core.datatype.xsd.regex.RegExp
                public boolean matches(String str2) {
                    try {
                        return ((Boolean) JDKImpl.this.matches.invoke(objNewInstance, str2)).booleanValue();
