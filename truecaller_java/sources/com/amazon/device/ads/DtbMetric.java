...
final class DtbMetric {
    ...
    static {
        ...
        DtbMetric dtbMetric11 = new DtbMetric("SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED", 10, ne.f114883b1, ne.f114883b1, dtbMetricType2);
    ...
    private DtbMetric(String str, int i11, String str2, String str3, DtbMetricType dtbMetricType) {
    ...
    public String toString() {
        return d9.i.f112571d + getAAXName() + ", " + getMetricType() + d9.i.f112573e;
    }
}
