...
public final class DTBAdNetwork {
    ...
    static {
        ...
        DTBAdNetwork dTBAdNetwork9 = new DTBAdNetwork(GrsBaseInfo.CountryCodeSource.UNKNOWN, 8, NetworkType.UNKNOWN);
    ...
    private DTBAdNetwork(String str, int i11, NetworkType networkType) {
