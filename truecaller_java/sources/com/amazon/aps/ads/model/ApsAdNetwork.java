...
public final class ApsAdNetwork {
    ...
    static {
        ...
        ApsAdNetwork apsAdNetwork9 = new ApsAdNetwork(GrsBaseInfo.CountryCodeSource.UNKNOWN, 8, ApsAdNetworkType.UNKNOWN);
        UNKNOWN = apsAdNetwork9;
        $VALUES = new ApsAdNetwork[]{apsAdNetwork, apsAdNetwork2, apsAdNetwork3, apsAdNetwork4, apsAdNetwork5, apsAdNetwork6, apsAdNetwork7, apsAdNetwork8, apsAdNetwork9};
    }

    private ApsAdNetwork(String str, int i11, ApsAdNetworkType apsAdNetworkType) {
