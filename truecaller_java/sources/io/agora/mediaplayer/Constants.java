...
public class Constants {
    ...
    public enum MediaPlayerError {
        ...
        MediaPlayerError(int i11) {
            this.value = i11;
        }

        @CalledByNative("MediaPlayerError")
        public static MediaPlayerError fromNativeIndex(int i11) {
            return getErrorByValue(i11);
        }

        public static MediaPlayerError getErrorByValue(int i11) {
            for (MediaPlayerError mediaPlayerError : values()) {
                if (mediaPlayerError.value == i11) {
