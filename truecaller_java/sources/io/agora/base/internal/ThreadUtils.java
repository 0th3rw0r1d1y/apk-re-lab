...
public class ThreadUtils {
        ...
        if (handler.post(new Runnable() { // from class: io.agora.base.internal.ThreadUtils.3
            ...
            public void run() {
                try {
                    ...
                    c1CaughtException.f168663e = e12;
                }
            ...
            c1CaughtException.f168663e = new Exception("handler post fail at invokeAtFrontUninterruptibly !");
        }
        if (c1CaughtException.f168663e == null) {
            return c1Result.value;
        }
        RuntimeException runtimeException = new RuntimeException(c1CaughtException.f168663e);
        runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f168663e.getStackTrace(), runtimeException.getStackTrace()));
        throw runtimeException;
    }

    public static boolean joinUninterruptibly(Thread thread, long j11) throws InterruptedException {
    ...
    public static boolean awaitUninterruptibly(CountDownLatch countDownLatch, long j11) throws InterruptedException {
        long jElapsedRealtime = SystemClock.elapsedRealtime();
