...
public class DrawableResources {
    ...
    public Bitmap getBitmap(Context context, Integer num, DrawableState drawableState) {
        ...
        byte[] bArrDecode = Base64.decode(drawableState == DrawableState.PRESSED ? this.INTERSTITIAL_CLOSE_BUTTON_PRESSED_Encoded : this.INTERSTITIAL_CLOSE_BUTTON_NORMAL_Encoded, 0);
