...
public class PNWebView extends WebView {
    ...
    public void destroy() {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: net.pubnative.lite.sdk.views.d
                @Override // java.lang.Runnable
                public final void run() {
                    this.f181562a.destroy();
                }
            });
            return;
        }
    ...
    public void enablePlugins(boolean z11) {
    }
