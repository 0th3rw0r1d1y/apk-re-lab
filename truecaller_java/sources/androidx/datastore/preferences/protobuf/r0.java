...
public final class r0 {
    ...
    public static final Unsafe f81027a;

    /* renamed from: b, reason: collision with root package name */
    public static final Class<?> f81028b;

    /* renamed from: c, reason: collision with root package name */
    public static final b f81029c;

    /* renamed from: d, reason: collision with root package name */
    public static final boolean f81030d;

    /* renamed from: e, reason: collision with root package name */
    public static final boolean f81031e;

    /* renamed from: f, reason: collision with root package name */
    public static final long f81032f;

    /* renamed from: g, reason: collision with root package name */
    public static final boolean f81033g;

    public static final class a extends b {
        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final boolean c(Object obj, long j11) {
            return this.f81034a.getBoolean(obj, j11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final double d(Object obj, long j11) {
            return this.f81034a.getDouble(obj, j11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final float e(Object obj, long j11) {
            return this.f81034a.getFloat(obj, j11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final void j(Object obj, long j11, boolean z11) {
            this.f81034a.putBoolean(obj, j11, z11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final void k(Object obj, long j11, byte b11) {
            this.f81034a.putByte(obj, j11, b11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final void l(Object obj, long j11, double d11) {
            this.f81034a.putDouble(obj, j11, d11);
        }

        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final void m(Object obj, long j11, float f11) {
            this.f81034a.putFloat(obj, j11, f11);
        }
        ...
        public final boolean q() {
            ...
            try {
                Class<?> cls = this.f81034a.getClass();
        ...
        public final boolean r() {
            ...
            if (unsafe != null) {
                try {
                    ...
                    if (r0.g() != null) {
                        try {
                            Class<?> cls3 = this.f81034a.getClass();
    ...
    public static abstract class b {
        ...
        public final int a(Class<?> cls) {
            return this.f81034a.arrayBaseOffset(cls);
        }

        public final int b(Class<?> cls) {
            return this.f81034a.arrayIndexScale(cls);
        }
        ...
        public final int f(Object obj, long j11) {
            return this.f81034a.getInt(obj, j11);
        }

        public final long g(Object obj, long j11) {
            return this.f81034a.getLong(obj, j11);
        }

        public final Object h(Object obj, long j11) {
            return this.f81034a.getObject(obj, j11);
        }

        public final long i(Field field) {
            return this.f81034a.objectFieldOffset(field);
        }
    ...
    public static final class baz extends b {
        @Override // androidx.datastore.preferences.protobuf.r0.b
        public final boolean c(Object obj, long j11) {
            return r0.f81033g ? r0.b(obj, j11) : r0.c(obj, j11);
        }
        ...
        public final void j(Object obj, long j11, boolean z11) {
            if (r0.f81033g) {
                r0.k(obj, j11, z11 ? (byte) 1 : (byte) 0);
            } else {
                r0.l(obj, j11, z11 ? (byte) 1 : (byte) 0);
            }
        }
    ...
    static {
        ...
        f81029c = aVar;
        f81030d = aVar == null ? false : aVar.r();
        f81031e = aVar == null ? false : aVar.q();
        f81032f = e(byte[].class);
        e(boolean[].class);
        f(boolean[].class);
        e(int[].class);
        f(int[].class);
        ...
        f81033g = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN;
    }
    ...
    public static boolean b(Object obj, long j11) {
        return ((byte) ((f81029c.f(obj, (-4) & j11) >>> ((int) (((~j11) & 3) << 3))) & 255)) != 0;
    }
    ...
    public static <T> T d(Class<T> cls) {
        try {
            return (T) f81027a.allocateInstance(cls);
    ...
    public static void j(byte[] bArr, long j11, byte b11) {
        f81029c.k(bArr, f81032f + j11, b11);
    }

    public static void k(Object obj, long j11, byte b11) {
        long j12 = (-4) & j11;
        int iF2 = f81029c.f(obj, j12);
        int i11 = ((~((int) j11)) & 3) << 3;
