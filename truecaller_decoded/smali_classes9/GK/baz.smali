.class public final LGK/baz;
.super Landroidx/room/N;
.source "SourceFile"


# instance fields
.field public final synthetic d:Lcom/truecaller/premium/domain/ruleengine/event/state/EventStateDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/premium/domain/ruleengine/event/state/EventStateDatabase_Impl;)V
    .locals 2

    .line 1
    iput-object p1, p0, LGK/baz;->d:Lcom/truecaller/premium/domain/ruleengine/event/state/EventStateDatabase_Impl;

    .line 2
    .line 3
    const-string p1, "4346d4b312342b5493b4ecc899588508"

    .line 4
    .line 5
    const-string v0, "0ef1baa16dd2c44f5e001b4953952acb"
...
.method public final a(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "CREATE TABLE IF NOT EXISTS `rule_state` (`state_key` TEXT NOT NULL, `value` TEXT NOT NULL, PRIMARY KEY(`state_key`))"
    ...
    .line 15
    .line 16
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'4346d4b312342b5493b4ecc899588508\')"
...
.method public final b(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "DROP TABLE IF EXISTS `rule_state`"
...
.method public final d(LM4/baz;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, LGK/baz;->d:Lcom/truecaller/premium/domain/ruleengine/event/state/EventStateDatabase_Impl;
...
.method public final g(LM4/baz;)Landroidx/room/N$bar;
    ...
    .line 39
    .line 40
    invoke-static {v0, v1, v3}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 67
    .line 68
    const-string v1, "rule_state(com.truecaller.premium.domain.ruleengine.event.state.RuleStateEntity).\n Expected:\n"
