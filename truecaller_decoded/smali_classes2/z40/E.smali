...
.method public synthetic constructor <init>(DILandroid/content/Context;Ljava/lang/String;Ljava/util/List;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/internal/L;Ltech/crackle/core_sdk/listener/CrackleAdViewAdListener;Ltech/crackle/core_sdk/ssp/c4;)V
    ...
    iput-object p8, p0, Lz40/E;->a:Lkotlin/jvm/internal/L;

    iput-wide p1, p0, Lz40/E;->b:D

    iput-object p4, p0, Lz40/E;->c:Landroid/content/Context;

    iput-object p10, p0, Lz40/E;->d:Ltech/crackle/core_sdk/ssp/c4;

    iput-object p6, p0, Lz40/E;->e:Ljava/util/List;

    iput p3, p0, Lz40/E;->f:I

    iput-object p5, p0, Lz40/E;->g:Ljava/lang/String;

    iput-object p9, p0, Lz40/E;->h:Ltech/crackle/core_sdk/listener/CrackleAdViewAdListener;

    iput-object p7, p0, Lz40/E;->i:Lkotlin/jvm/functions/Function1;
...
.method public final onAdManagerAdViewLoaded(Lcom/google/android/gms/ads/admanager/AdManagerAdView;)V
    ...
    .line 1
    iget-object v8, p0, Lz40/E;->h:Ltech/crackle/core_sdk/listener/CrackleAdViewAdListener;

    iget-object v9, p0, Lz40/E;->i:Lkotlin/jvm/functions/Function1;

    iget-object v0, p0, Lz40/E;->a:Lkotlin/jvm/internal/L;

    iget-wide v1, p0, Lz40/E;->b:D

    iget-object v3, p0, Lz40/E;->c:Landroid/content/Context;

    iget-object v4, p0, Lz40/E;->d:Ltech/crackle/core_sdk/ssp/c4;

    iget-object v5, p0, Lz40/E;->e:Ljava/util/List;

    iget v6, p0, Lz40/E;->f:I

    iget-object v7, p0, Lz40/E;->g:Ljava/lang/String;
