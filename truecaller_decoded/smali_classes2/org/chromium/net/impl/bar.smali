.class public final Lorg/chromium/net/impl/bar;
...
.field public b:Lorg/chromium/net/impl/e;
...
.method public constructor <init>(Lorg/chromium/net/BidirectionalStream$Callback;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onCanceled(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;)V
    .locals 3
    .param p1    # Landroid/net/http/BidirectionalStream;
    ...
    .line 1
    invoke-static {p2}, Lorg/chromium/net/impl/n1;->a(Landroid/net/http/UrlResponseInfo;)Lorg/chromium/net/impl/n1;
    ...
    .line 7
    :try_start_0
    iget-object v1, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;

    .line 8
    .line 9
    iget-object v2, p0, Lorg/chromium/net/impl/bar;->b:Lorg/chromium/net/impl/e;
    ...
    .line 13
    .line 14
    iget-object v1, p0, Lorg/chromium/net/impl/bar;->b:Lorg/chromium/net/impl/e;

    .line 15
    .line 16
    invoke-virtual {v1, v0, p1, p2}, Lorg/chromium/net/impl/e;->a(ILorg/chromium/net/impl/n1;Lorg/chromium/net/CronetException;)V
    ...
    .line 22
    .line 23
    invoke-virtual {v2, v0, p1, p2}, Lorg/chromium/net/impl/e;->a(ILorg/chromium/net/impl/n1;Lorg/chromium/net/CronetException;)V
...
.method public final onFailed(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    .line 10
    :try_start_0
    iget-object v0, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;
    ...
    .line 16
    .line 17
    iget-object v0, p0, Lorg/chromium/net/impl/bar;->b:Lorg/chromium/net/impl/e;

    .line 18
    .line 19
    invoke-virtual {v0, p3, p1, p2}, Lorg/chromium/net/impl/e;->a(ILorg/chromium/net/impl/n1;Lorg/chromium/net/CronetException;)V
    ...
    .line 25
    .line 26
    invoke-virtual {v1, p3, p1, p2}, Lorg/chromium/net/impl/e;->a(ILorg/chromium/net/impl/n1;Lorg/chromium/net/CronetException;)V
...
.method public final onReadCompleted(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Ljava/nio/ByteBuffer;Z)V
    ...
    .line 5
    iget-object p2, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onResponseTrailersReceived(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HeaderBlock;)V
    ...
    .param p2    # Landroid/net/http/UrlResponseInfo;
        ...
        .end annotation
    .end param
    .param p3    # Landroid/net/http/HeaderBlock;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 5
    new-instance p2, Lorg/chromium/net/impl/k;

    .line 6
    .line 7
    invoke-direct {p2, p3}, Lorg/chromium/net/impl/k;-><init>(Landroid/net/http/HeaderBlock;)V

    .line 8
    .line 9
    .line 10
    iget-object p3, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onStreamReady(Landroid/net/http/BidirectionalStream;)V
    ...
    .line 1
    iget-object p1, p0, Lorg/chromium/net/impl/bar;->a:Lorg/chromium/net/BidirectionalStream$Callback;
