...
.method private static addCronetProviderFromResourceFile(Landroid/content/Context;Lorg/chromium/net/impl/K1$a;Ljava/util/Set;)Z
    .locals 4
    ...
    .line 61
    invoke-static {p0, v0, p1, p2, v1}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/K1$a;Ljava/util/Set;Z)Z
...
.method private static addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/K1$a;Ljava/util/Set;Z)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 27
    new-instance v3, Lorg/chromium/net/CronetProvider$bar;

    .line 28
    .line 29
    invoke-direct {v3}, Lorg/chromium/net/CronetProvider$bar;-><init>()V
    ...
    .line 41
    .line 42
    iput-object p0, v3, Lorg/chromium/net/CronetProvider$bar;->a:Lorg/chromium/net/CronetProvider;

    .line 43
    .line 44
    iput-object p2, v3, Lorg/chromium/net/CronetProvider$bar;->b:Lorg/chromium/net/impl/K1$a;
...
.method public static getAllProviderInfos(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 7
    .line 8
    invoke-static {p0, v1, v0}, Lorg/chromium/net/CronetProvider;->addCronetProviderFromResourceFile(Landroid/content/Context;Lorg/chromium/net/impl/K1$a;Ljava/util/Set;)Z
    ...
    .line 12
    .line 13
    sget-object v2, Lorg/chromium/net/impl/K1$a;->c:Lorg/chromium/net/impl/K1$a;
    ...
    .line 16
    invoke-static {p0, v1, v2, v0, v3}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/K1$a;Ljava/util/Set;Z)Z
    ...
    .line 25
    .line 26
    sget-object v2, Lorg/chromium/net/impl/K1$a;->b:Lorg/chromium/net/impl/K1$a;
    ...
    .line 32
    .line 33
    sget-object v2, Lorg/chromium/net/impl/K1$a;->d:Lorg/chromium/net/impl/K1$a;
...
.method public static getAllProviders(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 24
    check-cast v1, Lorg/chromium/net/CronetProvider$bar;

    .line 25
    .line 26
    iget-object v1, v1, Lorg/chromium/net/CronetProvider$bar;->a:Lorg/chromium/net/CronetProvider;
