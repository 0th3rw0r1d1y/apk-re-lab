...
.method public static create(Landroid/os/ParcelFileDescriptor;)Lorg/chromium/net/UploadDataProvider;
    ...
    new-instance v1, LR30/baz;

    invoke-direct {v1, p0}, LR30/baz;-><init>(Landroid/os/ParcelFileDescriptor;)V

    invoke-direct {v0, v1}, LR30/b;-><init>(LR30/a;)V
...
.method public static create(Ljava/io/File;)Lorg/chromium/net/UploadDataProvider;
    ...
    new-instance v1, LR30/bar;

    invoke-direct {v1, p0}, LR30/bar;-><init>(Ljava/io/File;)V
...
.method public static create(Ljava/nio/ByteBuffer;)Lorg/chromium/net/UploadDataProvider;
    ...
    .line 3
    new-instance v0, LR30/qux;

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->slice()Ljava/nio/ByteBuffer;

    move-result-object p0

    invoke-direct {v0, p0}, LR30/qux;-><init>(Ljava/nio/ByteBuffer;)V
...
.method public static create([B)Lorg/chromium/net/UploadDataProvider;
    ...
    invoke-direct {v1, p0}, LR30/qux;-><init>(Ljava/nio/ByteBuffer;)V
