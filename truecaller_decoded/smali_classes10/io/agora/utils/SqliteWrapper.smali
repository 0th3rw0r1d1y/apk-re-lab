...
.method public load(Ljava/lang/String;Ljava/lang/String;Z)Lio/agora/utils/SqliteWrapper$StorageItem;
    .locals 8
    .annotation build Lio/agora/base/internal/CalledByNative;
    .end annotation

    const-string p3, "select key, value, expired from \""
    ...
    :cond_a
    new-instance v2, Lio/agora/utils/SqliteWrapper$StorageItem;

    move-wide v6, p1

    invoke-direct/range {v2 .. v7}, Lio/agora/utils/SqliteWrapper$StorageItem;-><init>([BJJ)V
...
.method public open(Ljava/lang/String;)Z
    ...
    invoke-static {}, Lio/agora/utils/c;->a()V

    invoke-static {}, Lio/agora/utils/b;->a()Landroid/database/sqlite/SQLiteDatabase$OpenParams$Builder;

    move-result-object v4

    invoke-static {v4}, Lio/agora/utils/bar;->a(Landroid/database/sqlite/SQLiteDatabase$OpenParams$Builder;)V

    invoke-static {v4}, Lio/agora/utils/baz;->a(Landroid/database/sqlite/SQLiteDatabase$OpenParams$Builder;)V

    invoke-static {v4}, Lio/agora/utils/qux;->a(Landroid/database/sqlite/SQLiteDatabase$OpenParams$Builder;)Landroid/database/sqlite/SQLiteDatabase$OpenParams;
    ...
    invoke-static {v5, v4}, Lio/agora/utils/a;->a(Ljava/io/File;Landroid/database/sqlite/SQLiteDatabase$OpenParams;)Landroid/database/sqlite/SQLiteDatabase;
