...
.method static constructor <clinit>()V
    ...
    invoke-direct {v13, v15, v2, v2}, Lio/agora/rtc2/Constants$VideoSourceType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v2, "VIDEO_SOURCE_RTC_IMAGE_GIF"

    move/from16 v18, v4

    const/16 v4, 0x8

    invoke-direct {v15, v2, v4, v4}, Lio/agora/rtc2/Constants$VideoSourceType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v4, "VIDEO_SOURCE_REMOTE"

    move/from16 v20, v6

    const/16 v6, 0x9

    invoke-direct {v2, v4, v6, v6}, Lio/agora/rtc2/Constants$VideoSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/rtc2/Constants$VideoSourceType;->VIDEO_SOURCE_REMOTE:Lio/agora/rtc2/Constants$VideoSourceType;

    new-instance v4, Lio/agora/rtc2/Constants$VideoSourceType;

    move/from16 v21, v6

    const-string v6, "VIDEO_SOURCE_TRANSCODED"

    move/from16 v22, v8

    const/16 v8, 0xa

    invoke-direct {v4, v6, v8, v8}, Lio/agora/rtc2/Constants$VideoSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/rtc2/Constants$VideoSourceType;->VIDEO_SOURCE_TRANSCODED:Lio/agora/rtc2/Constants$VideoSourceType;
    ...
    const-string v10, "VIDEO_SOURCE_UNKNOWN"

    move/from16 v25, v12

    const/16 v12, 0xb

    invoke-direct {v6, v10, v12, v8}, Lio/agora/rtc2/Constants$VideoSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lio/agora/rtc2/Constants$VideoSourceType;->VIDEO_SOURCE_UNKNOWN:Lio/agora/rtc2/Constants$VideoSourceType;

    const/16 v8, 0xc

    new-array v8, v8, [Lio/agora/rtc2/Constants$VideoSourceType;
    ...
    sput-object v8, Lio/agora/rtc2/Constants$VideoSourceType;->$VALUES:[Lio/agora/rtc2/Constants$VideoSourceType;
