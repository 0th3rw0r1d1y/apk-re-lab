...
.method static constructor <clinit>()V
    ...
    invoke-direct {v13, v15, v2, v2}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v2, "RTC_IMAGE_PNG_SOURCE"

    move/from16 v18, v4

    const/16 v4, 0x8

    invoke-direct {v15, v2, v4, v4}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v4, "RTC_IMAGE_JPEG_SOURCE"

    move/from16 v20, v6

    const/16 v6, 0x9

    invoke-direct {v2, v4, v6, v6}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/rtc2/Constants$MediaSourceType;->RTC_IMAGE_JPEG_SOURCE:Lio/agora/rtc2/Constants$MediaSourceType;

    new-instance v4, Lio/agora/rtc2/Constants$MediaSourceType;

    move/from16 v21, v6

    const-string v6, "RTC_IMAGE_GIF_SOURCE"

    move/from16 v22, v8

    const/16 v8, 0xa

    invoke-direct {v4, v6, v8, v8}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/rtc2/Constants$MediaSourceType;->RTC_IMAGE_GIF_SOURCE:Lio/agora/rtc2/Constants$MediaSourceType;
    ...
    invoke-direct {v6, v8, v10, v10}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lio/agora/rtc2/Constants$MediaSourceType;->REMOTE_VIDEO_SOURCE:Lio/agora/rtc2/Constants$MediaSourceType;

    new-instance v8, Lio/agora/rtc2/Constants$MediaSourceType;

    move/from16 v25, v10

    const-string v10, "TRANSCODED_VIDEO_SOURCE"

    move/from16 v26, v12

    const/16 v12, 0xc

    invoke-direct {v8, v10, v12, v12}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v14, "UNKNOWN_MEDIA_SOURCE"

    move-object/from16 v29, v0

    const/16 v0, 0xd

    invoke-direct {v10, v14, v0, v12}, Lio/agora/rtc2/Constants$MediaSourceType;-><init>(Ljava/lang/String;II)V

    sput-object v10, Lio/agora/rtc2/Constants$MediaSourceType;->UNKNOWN_MEDIA_SOURCE:Lio/agora/rtc2/Constants$MediaSourceType;

    const/16 v12, 0xe

    new-array v12, v12, [Lio/agora/rtc2/Constants$MediaSourceType;
    ...
    sput-object v12, Lio/agora/rtc2/Constants$MediaSourceType;->$VALUES:[Lio/agora/rtc2/Constants$MediaSourceType;
