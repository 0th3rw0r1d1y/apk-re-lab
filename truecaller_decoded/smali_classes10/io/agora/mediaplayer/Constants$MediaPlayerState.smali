...
.method static constructor <clinit>()V
    ...
    invoke-direct {v13, v15, v3, v14}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    const-string v4, "PLAYER_STATE_STOPPED"

    move/from16 v18, v6

    const/16 v6, 0x8

    invoke-direct {v15, v4, v6, v3}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    const-string v6, "PLAYER_STATE_PAUSING_INTERNAL"

    move/from16 v21, v8

    const/16 v8, 0x9

    invoke-direct {v4, v6, v8, v3}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_PAUSING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    invoke-direct {v3, v8, v10, v6}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_STOPPING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    invoke-direct {v6, v10, v12, v8}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    const-string v12, "PLAYER_STATE_GETTING_INTERNAL"

    move/from16 v27, v14

    const/16 v14, 0xc

    invoke-direct {v8, v12, v14, v10}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v8, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_GETTING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    const-string v14, "PLAYER_STATE_NONE_INTERNAL"

    move-object/from16 v29, v0

    const/16 v0, 0xd

    invoke-direct {v10, v14, v0, v12}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v10, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_NONE_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    const-string v0, "PLAYER_STATE_DO_NOTHING_INTERNAL"

    move-object/from16 v31, v1

    const/16 v1, 0xe

    invoke-direct {v12, v0, v1, v14}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v12, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_DO_NOTHING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    const-string v1, "PLAYER_STATE_SET_TRACK_INTERNAL"

    move-object/from16 v33, v2

    const/16 v2, 0xf

    invoke-direct {v0, v1, v2, v14}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    const-string v2, "PLAYER_STATE_FAILED"

    move-object/from16 v35, v0

    const/16 v0, 0x10

    invoke-direct {v1, v2, v0, v14}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
