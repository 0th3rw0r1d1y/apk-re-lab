...
# instance fields
.field public final synthetic d:Lcom/truecaller/voicemail/domain/data/db/VoicemailDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/voicemail/domain/data/db/VoicemailDatabase_Impl;)V
    .locals 2

    .line 1
    iput-object p1, p0, LtX/baz;->d:Lcom/truecaller/voicemail/domain/data/db/VoicemailDatabase_Impl;

    .line 2
    .line 3
    const-string p1, "a87059915f996cf3e2e84dbd71bb9325"

    .line 4
    .line 5
    const-string v0, "245d14742987356a76613b9689a7e708"
...
.method public final a(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "CREATE TABLE IF NOT EXISTS `voicemail` (`id` TEXT NOT NULL, `clientCallId` TEXT, `to` TEXT, `from` TEXT NOT NULL, `duration` INTEGER NOT NULL, `shortTranscription` TEXT, `fullTranscription` TEXT, `recordingFilePath` TEXT, `createdAt` INTEGER NOT NULL, `isDeletedFromRemote` INTEGER NOT NULL, `fileSignature` TEXT, PRIMARY KEY(`id`))"
    ...
    .line 15
    .line 16
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'a87059915f996cf3e2e84dbd71bb9325\')"
...
.method public final b(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "DROP TABLE IF EXISTS `voicemail`"
...
.method public final d(LM4/baz;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, LtX/baz;->d:Lcom/truecaller/voicemail/domain/data/db/VoicemailDatabase_Impl;
...
.method public final g(LM4/baz;)Landroidx/room/N$bar;
    ...
    .line 102
    const-string v10, "shortTranscription"
    ...
    .line 120
    const-string v11, "fullTranscription"
    ...
    .line 127
    .line 128
    const-string v2, "fullTranscription"
    ...
    .line 139
    const-string v12, "recordingFilePath"
    ...
    .line 175
    const-string v6, "isDeletedFromRemote"
    ...
    .line 229
    .line 230
    const-string v2, "voicemail(com.truecaller.voicemail.domain.data.db.entity.VoicemailEntity).\n Expected:\n"
