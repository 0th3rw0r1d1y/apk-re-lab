.class public final Lfk/baz;
.super Landroidx/room/N;
.source "SourceFile"


# instance fields
.field public final synthetic d:Lcom/truecaller/bizmon/dynamicCalls/db/BizDynamicContactDb_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/bizmon/dynamicCalls/db/BizDynamicContactDb_Impl;)V
    .locals 2

    .line 1
    iput-object p1, p0, Lfk/baz;->d:Lcom/truecaller/bizmon/dynamicCalls/db/BizDynamicContactDb_Impl;

    .line 2
    .line 3
    const-string p1, "d4baaf54b0e8c027b0e873b5b0ac3b62"

    .line 4
    .line 5
    const-string v0, "c0097ec6ac9d42d7b16eada784db3e5b"
...
.method public final a(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "CREATE TABLE IF NOT EXISTS `biz_dynamic_contact` (`business_phone_number` TEXT NOT NULL, `start_time` INTEGER NOT NULL, `end_time` INTEGER NOT NULL, `caller_name` TEXT NOT NULL, `call_reason` TEXT, `logo_url` TEXT, `tag` TEXT, `badge` TEXT NOT NULL, `request_id` TEXT NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)"
    ...
    .line 10
    .line 11
    const-string v0, "CREATE UNIQUE INDEX IF NOT EXISTS `index_biz_dynamic_contact_business_phone_number` ON `biz_dynamic_contact` (`business_phone_number`)"
    ...
    .line 20
    .line 21
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'d4baaf54b0e8c027b0e873b5b0ac3b62\')"
...
.method public final b(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "DROP TABLE IF EXISTS `biz_dynamic_contact`"
...
.method public final d(LM4/baz;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, Lfk/baz;->d:Lcom/truecaller/bizmon/dynamicCalls/db/BizDynamicContactDb_Impl;
...
.method public final g(LM4/baz;)Landroidx/room/N$bar;
    ...
    .line 14
    const-string v4, "business_phone_number"
    ...
    .line 205
    const-string v7, "index_biz_dynamic_contact_business_phone_number"
    ...
    .line 215
    .line 216
    const-string v5, "biz_dynamic_contact"
    ...
    .line 232
    .line 233
    const-string v2, "biz_dynamic_contact(com.truecaller.bizmon.dynamicCalls.db.entity.BizDynamicContactEntity).\n Expected:\n"
