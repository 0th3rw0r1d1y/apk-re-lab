.class public final Lhl/bar$bar;
.super LlW/c;
.source "SourceFile"
...
.method public constructor <init>(LnW/d;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lhl/bar$bar;->b:LnW/baz;
...
.method public final j2(ILandroid/content/Context;)V
    ...
    .line 7
    const-string v1, "callAlertIncomingCallSimId"
    ...
    .line 30
    invoke-virtual {p0, p2, v0}, LlW/c;->i2(Landroid/content/SharedPreferences;Ljava/util/Set;)I
    ...
    .line 49
    :cond_1
    iget-object p2, p0, Lhl/bar$bar;->b:LnW/baz;

    .line 50
    .line 51
    invoke-interface {p2, p1}, LnW/baz;->a(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 63
    invoke-virtual {p0, p2, p1}, LlW/d;->putInt(Ljava/lang/String;I)V
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v1}, LlW/d;->remove(Ljava/lang/String;)V
