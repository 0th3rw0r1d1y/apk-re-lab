...
.method public final c(Lcom/truecaller/database/framework/bar;LAu/bar;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .line 19
    .line 20
    const-string p3, "SELECT ms.message_id, ms.entity_info1, m.info13, p.normalized_destination FROM msg_entities as ms INNER JOIN msg_messages m INNER JOIN msg_participants p WHERE ms.message_id = m._id AND m.participant_id = p._id AND ms.type like \'application/vnd.gsma.botmessage%\' AND ms.entity_type != 10"
