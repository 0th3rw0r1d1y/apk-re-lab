...
.method public final c(Lcom/truecaller/database/framework/bar;LAu/bar;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .line 19
    .line 20
    const-string p3, "SELECT * FROM (SELECT c.type, c._id AS conversation_id, c.archived_date AS archived_date, GROUP_CONCAT(ac.contact_name) AS participants_names, GROUP_CONCAT(p.normalized_destination) AS participants_normalized_addresses, ts.snippet_text AS snippet_text, ts.latest_message_media_count AS latest_message_media_count, ts.latest_message_media_type AS latest_message_media_type, ts.latest_message_category AS latest_message_category, ts.date_sorting AS date_sorting, ts.latest_message_status AS latest_message_status, ts.latest_message_transport AS latest_message_transport FROM msg_conversations c LEFT JOIN msg_conversation_participants cp ON c._id = cp.conversation_id LEFT JOIN msg_thread_stats ts ON ts.conversation_id = c._id LEFT JOIN msg_participants p ON cp.participant_id = p._id LEFT JOIN aggregated_contact ac ON ac._id = p.aggregated_contact_id WHERE ts.filter = 1 GROUP BY c._id ) se WHERE se.type = 1 "
    ...
    .line 30
    .line 31
    invoke-static {p3, p5, p4, p2}, LF8/bar;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
