...
.method public final d(Lcom/truecaller/database/framework/bar;LAu/bar;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 68
    :cond_0
    sget-object v4, Lcom/truecaller/blocking/api/model/FilterState;->ENABLED:Lcom/truecaller/blocking/api/model/FilterState;

    .line 69
    .line 70
    invoke-virtual {v4}, Lcom/truecaller/blocking/api/model/FilterState;->getValue()I
    ...
    .line 103
    :try_start_0
    invoke-virtual {v3, v0, v6, p4, v7}, Landroid/database/sqlite/SQLiteDatabase;->insertWithOnConflict(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;I)J
    ...
    .line 108
    :catch_0
    const-string v6, "value=? AND tracking_type=? "
    ...
    .line 114
    invoke-virtual {v3, v0, p4, v6, v8}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 120
    .line 121
    invoke-direct {p4, v5}, Landroid/content/ContentValues;-><init>(I)V
    ...
    .line 197
    const-string v0, "normalized_destination = ? AND type = ?"

    .line 198
    .line 199
    invoke-virtual {v3, v1, p4, v0, p3}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
