...
.method public final a()[Ljava/lang/String;
    ...
    .line 1
    const-string v0, "CREATE INDEX idx_msg_im_users_im_peer_id ON msg_im_users(im_peer_id)"

    .line 2
    .line 3
    const-string v1, "CREATE INDEX idx_msg_im_users_normalized_number ON msg_im_users(normalized_number)"

    .line 4
    .line 5
    const-string v2, "CREATE TABLE msg_im_users(normalized_number TEXT UNIQUE, im_peer_id TEXT UNIQUE, date INTEGER NOT NULL, join_im_notification INTEGER NOT NULL DEFAULT 0, registration_timestamp INTEGER NOT NULL DEFAULT 0, tc_id TEXT, fallback_name TEXT, CHECK(normalized_number NOT NULL OR im_peer_id NOT NULL) ON CONFLICT REPLACE)"
