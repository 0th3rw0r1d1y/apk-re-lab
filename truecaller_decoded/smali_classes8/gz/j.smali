...
# instance fields
.field public final synthetic d:Lcom/truecaller/familyprotect/domain/data/db/FamilyGroupDb_Impl;


# direct methods
.method public constructor <init>(Lcom/truecaller/familyprotect/domain/data/db/FamilyGroupDb_Impl;)V
    .locals 2

    .line 1
    iput-object p1, p0, Lgz/j;->d:Lcom/truecaller/familyprotect/domain/data/db/FamilyGroupDb_Impl;

    .line 2
    .line 3
    const-string p1, "4cbd07cb93151b498f5350b28caee95f"

    .line 4
    .line 5
    const-string v0, "709b1a4571b16064691dca113845f720"
...
.method public final a(LM4/baz;)V
    ...
    .line 5
    .line 6
    const-string v0, "CREATE TABLE IF NOT EXISTS `group_participants` (`phone_number` TEXT NOT NULL, `group_id` TEXT NOT NULL, `state` TEXT NOT NULL, `role` TEXT NOT NULL, `os` TEXT NOT NULL, `invited_by_phone_number` TEXT, PRIMARY KEY(`phone_number`))"
    ...
    .line 10
    .line 11
    const-string v0, "CREATE TABLE IF NOT EXISTS `block_patterns` (`value` TEXT NOT NULL, `type` TEXT NOT NULL, `label` TEXT, `timestamp` INTEGER, `entity_type` TEXT NOT NULL, PRIMARY KEY(`value`, `type`))"
    ...
    .line 15
    .line 16
    const-string v0, "CREATE TABLE IF NOT EXISTS `auto_reject_sources_config` (`source` TEXT NOT NULL, `os` TEXT NOT NULL, `isPremium` INTEGER NOT NULL, PRIMARY KEY(`source`))"
    ...
    .line 20
    .line 21
    const-string v0, "CREATE TABLE IF NOT EXISTS `block_pattern_config` (`type` TEXT NOT NULL, `os` TEXT NOT NULL, `isPremium` INTEGER NOT NULL, PRIMARY KEY(`type`))"
    ...
    .line 25
    .line 26
    const-string v0, "CREATE TABLE IF NOT EXISTS `user_device_state` (`phone_number` TEXT NOT NULL, `os` TEXT, `permissions` TEXT NOT NULL, `source` TEXT NOT NULL, PRIMARY KEY(`phone_number`))"
    ...
    .line 30
    .line 31
    const-string v0, "CREATE TABLE IF NOT EXISTS `permission_config` (`name` TEXT NOT NULL, `os` TEXT, `severity` TEXT NOT NULL, `min_os_version` TEXT, PRIMARY KEY(`name`))"
    ...
    .line 40
    .line 41
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'4cbd07cb93151b498f5350b28caee95f\')"
...
.method public final b(LM4/baz;)V
    ...
    .line 10
    .line 11
    const-string v0, "DROP TABLE IF EXISTS `block_patterns`"
    ...
    .line 15
    .line 16
    const-string v0, "DROP TABLE IF EXISTS `auto_reject_sources_config`"
    ...
    .line 20
    .line 21
    const-string v0, "DROP TABLE IF EXISTS `block_pattern_config`"
    ...
    .line 25
    .line 26
    const-string v0, "DROP TABLE IF EXISTS `user_device_state`"
    ...
    .line 30
    .line 31
    const-string v0, "DROP TABLE IF EXISTS `permission_config`"
...
.method public final d(LM4/baz;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, Lgz/j;->d:Lcom/truecaller/familyprotect/domain/data/db/FamilyGroupDb_Impl;
...
.method public final g(LM4/baz;)Landroidx/room/N$bar;
    ...
    .line 101
    const-string v10, "invited_by_phone_number"
    ...
    .line 108
    .line 109
    const-string v4, "invited_by_phone_number"
    ...
    .line 141
    .line 142
    const-string v2, "group_participants(com.truecaller.familyprotect.domain.data.db.GroupParticipantEntity).\n Expected:\n"
    ...
    .line 246
    .line 247
    invoke-static {v1, v6, v12}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 257
    .line 258
    const-string v10, "block_patterns"
    ...
    .line 274
    .line 275
    const-string v2, "block_patterns(com.truecaller.familyprotect.domain.protectionconfig.data.db.FamilyBlockPatternEntity).\n Expected:\n"
    ...
    .line 337
    .line 338
    invoke-static {v1, v8, v10}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 348
    .line 349
    const-string v12, "auto_reject_sources_config"

    .line 350
    .line 351
    invoke-direct {v11, v12, v1, v9, v10}, LJ4/o;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    .line 365
    .line 366
    const-string v2, "auto_reject_sources_config(com.truecaller.familyprotect.domain.protectionconfig.data.db.AutoRejectSourceConfigEntity).\n Expected:\n"

    .line 367
    .line 368
    invoke-static {v2, v11, v5, v1}, Landroidx/work/impl/Q;->a(Ljava/lang/String;LJ4/o;Ljava/lang/String;LJ4/o;)Ljava/lang/String;
    ...
    .line 425
    .line 426
    invoke-static {v1, v8, v11}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 436
    .line 437
    const-string v10, "block_pattern_config"

    .line 438
    .line 439
    invoke-direct {v9, v10, v1, v4, v8}, LJ4/o;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    .line 453
    .line 454
    const-string v2, "block_pattern_config(com.truecaller.familyprotect.domain.protectionconfig.data.db.BlockPatternConfigEntity).\n Expected:\n"
    ...
    .line 531
    .line 532
    invoke-static {v1, v6, v11}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 542
    .line 543
    const-string v8, "user_device_state"

    .line 544
    .line 545
    invoke-direct {v6, v8, v1, v3, v4}, LJ4/o;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    .line 559
    .line 560
    const-string v2, "user_device_state(com.truecaller.familyprotect.domain.permissionconfig.data.db.UserDeviceStateEntity).\n Expected:\n"
    ...
    .line 633
    const-string v13, "min_os_version"
    ...
    .line 641
    .line 642
    const-string v2, "min_os_version"

    .line 643
    .line 644
    invoke-static {v1, v2, v11}, Lcf/g;->a(Ljava/util/LinkedHashMap;Ljava/lang/String;LJ4/o$bar;)Ljava/util/LinkedHashSet;
    ...
    .line 654
    .line 655
    const-string v6, "permission_config"
    ...
    .line 671
    .line 672
    const-string v2, "permission_config(com.truecaller.familyprotect.domain.permissionconfig.data.db.staticconfig.PermissionConfigEntity).\n Expected:\n"
