...
.method public final r0(LZ7/e;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 68
    .line 69
    invoke-direct {v0, p1, v1, p2}, Lf8/qux;-><init>(LP7/i;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 106
    .line 107
    invoke-direct {p1, p2, v4}, Ljava/net/InetSocketAddress;-><init>(Ljava/lang/String;I)V
    ...
    .line 216
    invoke-direct {v1, p1, v0, p2}, Ljava/util/Locale;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 254
    .line 255
    invoke-virtual {v1, p1}, Ljava/util/Locale$Builder;->setLanguage(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 267
    invoke-virtual {v1, p2}, Ljava/util/Locale$Builder;->setScript(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 271
    invoke-virtual {p2}, Ljava/util/Locale$Builder;->build()Ljava/util/Locale;
    ...
    .line 285
    invoke-virtual {v2, v0}, Ljava/util/Locale$Builder;->setRegion(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 289
    invoke-virtual {v2, v6}, Ljava/util/Locale$Builder;->setVariant(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 303
    invoke-virtual {v2, v3, p2}, Ljava/util/Locale$Builder;->setExtension(CLjava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 320
    .line 321
    invoke-virtual {v3, p1}, Ljava/util/Locale$Builder;->setLanguage(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 325
    invoke-virtual {v3, v0}, Ljava/util/Locale$Builder;->setRegion(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 329
    invoke-virtual {v3, v6}, Ljava/util/Locale$Builder;->setVariant(Ljava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 359
    invoke-virtual {v3, v4, p2}, Ljava/util/Locale$Builder;->setExtension(CLjava/lang/String;)Ljava/util/Locale$Builder;
    ...
    .line 369
    .line 370
    invoke-direct {p2, p1, v0, v6}, Ljava/util/Locale;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 381
    .line 382
    const-string v5, "Invalid Pattern, problem: "
    ...
    .line 421
    invoke-virtual {p1, p2}, Lr8/s;->h(Ljava/lang/String;)LZ7/h;
    ...
    .line 443
    invoke-virtual {p1, p2, v3}, LZ7/e;->A(Ljava/lang/Throwable;Ljava/lang/Class;)V
...
.method public final u0(LZ7/e;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-virtual {p0, p1}, Le8/o$bar;->l(LZ7/e;)Ljava/lang/Object;
