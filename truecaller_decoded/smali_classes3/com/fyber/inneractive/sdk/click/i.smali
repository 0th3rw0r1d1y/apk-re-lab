...
.method public final a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)Lcom/fyber/inneractive/sdk/click/b;
    ...
    .line 16
    :cond_2
    sget-object v1, Lcom/fyber/inneractive/sdk/util/d0;->OPEN_EVERYTHING:Lcom/fyber/inneractive/sdk/util/d0;
    ...
    .line 23
    new-instance v6, Lcom/fyber/inneractive/sdk/util/b0;

    sget-object v7, Lcom/fyber/inneractive/sdk/util/e0;->OPEN_IN_EXTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/e0;

    invoke-direct {v6, v7, v2}, Lcom/fyber/inneractive/sdk/util/b0;-><init>(Lcom/fyber/inneractive/sdk/util/e0;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :catchall_1
    :try_start_4
    invoke-static {v0}, Lcom/fyber/inneractive/sdk/util/f0;->d(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_5

    invoke-static {v0}, Lcom/fyber/inneractive/sdk/util/f0;->c(Ljava/lang/String;)Z
    ...
    .line 25
    sget-object v6, Lcom/fyber/inneractive/sdk/util/d0;->DO_NOT_OPEN_IN_INTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/d0;
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/e0;->OPENED_IN_INTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/e0;

    invoke-direct {v6, p1, v2}, Lcom/fyber/inneractive/sdk/util/b0;-><init>(Lcom/fyber/inneractive/sdk/util/e0;Ljava/lang/Throwable;)V
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/e0;->FAILED:Lcom/fyber/inneractive/sdk/util/e0;

    new-instance v1, Lcom/fyber/inneractive/sdk/util/c0;

    const-string v5, "canOpenInExternalBrowser has decided it cant be opened and shouldUseInternalBrowser was set to true"

    invoke-direct {v1, v5}, Lcom/fyber/inneractive/sdk/util/c0;-><init>(Ljava/lang/String;)V

    invoke-direct {v6, p1, v1}, Lcom/fyber/inneractive/sdk/util/b0;-><init>(Lcom/fyber/inneractive/sdk/util/e0;Ljava/lang/Throwable;)V

    goto :goto_4

    .line 34
    :catch_1
    invoke-static {p1, v0}, Lcom/fyber/inneractive/sdk/util/f0;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/e0;->OPENED_USING_CHROME_NAVIGATE:Lcom/fyber/inneractive/sdk/util/e0;
    ...
    sget-object v1, Lcom/fyber/inneractive/sdk/util/e0;->FAILED:Lcom/fyber/inneractive/sdk/util/e0;

    invoke-direct {v6, v1, p1}, Lcom/fyber/inneractive/sdk/util/b0;-><init>(Lcom/fyber/inneractive/sdk/util/e0;Ljava/lang/Throwable;)V

    :goto_4
    if-eqz p3, :cond_8

    .line 39
    iget-object p1, v6, Lcom/fyber/inneractive/sdk/util/b0;->b:Ljava/lang/Throwable;
    ...
    sget-object v1, Lcom/fyber/inneractive/sdk/click/q;->OPENED_IN_EXTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/click/q;

    .line 42
    invoke-direct {p1, v0, v4, v1, v2}, Lcom/fyber/inneractive/sdk/click/j;-><init>(Ljava/lang/String;ZLcom/fyber/inneractive/sdk/click/q;Ljava/lang/String;)V
